import csv
f1=open("/mnt/c/Users/Google/Documents/students_data.csv")
data2=csv.reader(f1)
new_list=[]
for info in data2:
...
faculty_file=open("/mnt/c/Users/Google/Documents/faculties_data.csv")
student_file=open("/mnt/c/Users/Google/Documents/students_data.csv")
